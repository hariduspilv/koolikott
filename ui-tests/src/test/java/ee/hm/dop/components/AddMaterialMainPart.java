...
public class AddMaterialMainPart extends PageComponent {
	...
	private By russianLanguage = By.xpath("/html/body/div[6]/md-select-menu/md-content/md-option[2]/div[1]/span");
	...
	/*public AddMaterialMainPart addDescription() {
		getDriver().findElement(descriptionField).sendKeys("Automation");
		return this;
	}*/
	...
	public AddMaterialMainPart setMaterialTitle() {
		String[] titlesArray = { "We Were Meant To Collide", "Strange drawnings", "20th Century Drama",
				"The Different Types Of People There Are On The Internet", "This Is Why Having More Money Just Brings New Problems",
				"For Every Student Struggling To Balance School And Work, This Is How You Do It", "Strong Is Beautiful But So Is Weakness",
				"How To Drink At Home By Yourself", "Anime", "How Many Cats Is Too Many Cats", "Counting Scars",
				"No One Said It Was Easy", "Helpful Tips On Productivity That Will End Your Procrastination",
				"What Does the Future of the Internet Look Like?", "The Laws of Gold Destroyed!", "Getting To Know The Monsters That Live Inside Us",
				...
				"10 Everyday Things Only Extroverted Introverts Will Understand", "Surreal crooked trees shaped by Antarctic winds",
				...
				"Moderate earthquake", "Estonian schools piloting open source software",
				...
				"Environmental Racism Is Not Just A Flint Problem", "What Is a Subway Metro Planner and How Can It Help You?",
				...
				"If You Create, You Are An Artist", "When Travel Is A Part Of You", "You don’t have to do what everyone else is doing",
				"How Do We Protect Communications Networks From Cyber Attacks?", "How to laugh",
				"Instant Gratification: How It's Ruining Our Lives And How We Can Stop It", "No age will give you the answers",
				"This Is The Reward Of Traveling Solo", "To Enjoy The Rainbow, You Must First Enjoy The Rain",
				"Just A Few Aliens Trying To Live The American Dream", "This Is Why It’s Important To Consider Your Western Footprint",
				...
				"Yellowstone Strange Light", "Organize your bookshelves by color", "What was the bravest thing you have ever done?",
				"This Is Why You Should Start Drinking Ginger Tea And How To Make It The Right Way", "How many times in our life do the seconds matter?",
				"The Realm of Buried Giants", "Mysterious Cosmic Radio Bursts Found To Repeat",
				"Carnival of Space #447", "Extraterrestrial Contact: Fears", "This cafe has taken the internet by storm.",
	...
	public AddMaterialMainPart uploadPhoto() {
		...
		String[] picsArray = { "c:\\Images\\helmet.jpg", "c:\\Images\\hobbit.jpg", "c:\\Images\\lill.jpg",
				...
				"c:\\Images\\caravagio.jpg", "c:\\Images\\white.jpg", "c:\\Images\\fyodor.jpg",
