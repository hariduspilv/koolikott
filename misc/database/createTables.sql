...
DROP TABLE IF EXISTS LearningObject_TargetGroup;
DROP TABLE IF EXISTS LearningObject_KeyCompetence;
DROP TABLE IF EXISTS LearningObject_CrossCurricularTheme;
DROP TABLE IF EXISTS LearningObject_Tag;
