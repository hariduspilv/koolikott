...
<p>Õppematerjalide ja kogumike sirvimiseks tuleb esmalt teostada otsing. Otsingutulemustes kuvatakse otsinguparameetritele 
vastavad materjalid ja/või kogumikud. Materjali või kogumiku avamisel kuvatakse esmalt nende põhiandmed (pealkiri, kirjeldus, 
taksonoomiline kuuluvus, autor jne). Õppematerjali avamiseks tuleb klikkida selle pildil või pildi puudumisel ikoonil.</p>

<h1>Kommenteerimine, meeldimine, püsilingid, ebasobivaks märkimine</h1>
<p>Kogumiku või materjali avamisel on võimalik lehe päises asuva menüü kaudu teavitada E-koolikoti administraatorit ebasobivast materjalist 
või katkisest lingist. Meeldivaks/mittemeeldivaks märkimida saab materjali või kogumikku põhiandmete all asuvate ikoonidel klikkimise teel. 
Kommentaaride lisamine ja vaatamine on samuti võimalik materjali või kogumiku põhiandmete all. Kommentaaride lisamise õigus on ainult autenditud kasutajatel.</p>

<h1>Kogumike loomine</h1>
<p>Autenditud kasutajatel on võimalik luua õpematerjalidest kogumikke. Selleks tuleb vajutada ekraani paremal allääres asuvast “+” nupule ning 
klikkida ikoonil “Lisa kogumik”. Avanevas aknas tuleb esmalt sisestada kogumiku põhiandmestik, mille järel avatakse kogumiku põhivaade. 
Vasakul asub sisukord, kuhu on võimalik lisada peatükke ja alampeatükke. Igasse peatükki ja alampeatükki on võimalik lisada soovitud õppematerjale. 
Selleks tuleb esmalt teostada otsing, mille järel on võimalik otsingutulemustes märkida ära sobivad materjalid. 
Õppematerjalide märkimise järel tuleb hiirega liikuda sisukorras sobivale peatükile või alampeatükile ning vajutada nuppu “Lisa”.</p>

<h1>Materjalide loomine</h1>
<p>Kogumiku loomisel on võimalik lisada E-koolikoti keskkonda uus õppematerjal. Selleks tuleb sisestada õppematerjali link vastava peatüki 
või alapeatüki kirjelduse järel asuvasse tekstivälja ning vajutada nuppu “Lisa”. Seejärel tuleb avanevas aknas sisestada õppematerjali põhiandmestik, 
