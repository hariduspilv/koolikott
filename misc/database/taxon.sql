...
insert into Taxon(id, name, level) values (101, 'Language_and_speach', 'DOMAIN');
...
insert into Taxon(id, name, level) values (103, 'Methematics', 'DOMAIN');
...
insert into Taxon(id, name, level) values (114, 'Physical education', 'DOMAIN');
...
insert into Taxon(id, name, level) values (124, 'Physical education', 'DOMAIN');
