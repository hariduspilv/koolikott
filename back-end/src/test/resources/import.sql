...
insert into Repository(id, baseURL, lastSynchronization, schemaName, isEstonianPublisher, metadataPrefix, used) values (1, 'http://repo1.ee', null, 'waramu', false, 'oai_estcore', true);
insert into Repository(id, baseURL, lastSynchronization, schemaName, isEstonianPublisher, metadataPrefix, used) values (2, 'http://estonianPublisher.ee/OAIHandler', null, 'estCore', true, 'oai_estcore', true);
