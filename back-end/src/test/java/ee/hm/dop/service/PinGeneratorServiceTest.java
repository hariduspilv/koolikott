...
public class PinGeneratorServiceTest {
    ...
    public void pin_is_generated_as_positive_number_up_to_4_digits() {
        String randomNumber1 = PinGeneratorService.generatePin();
        String randomNumber2 = PinGeneratorService.generatePin();
    ...
    private void assertLenght1To4Digits(String randomNumber1) {
