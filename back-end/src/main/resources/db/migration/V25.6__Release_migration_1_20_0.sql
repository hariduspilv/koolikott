...
UPDATE Translation set translation = 'Recently added first' WHERE translationKey = 'ADDED_DATE_DESC' and translationGroup = 3;
UPDATE Translation set translation = 'Earliest added first' WHERE translationKey = 'ADDED_DATE_ASC' and translationGroup = 3;
