...
#Kas id renamest piisab?
# INSERT INTO Row_Material (row) SELECT ContentRow.id FROM ContentRow JOIN Row_Material ON Row_Material.material = ContentRow.material AND
#                                                                Row_Material.chapter = ContentRow.chapter;
ALTER TABLE Row_Material
