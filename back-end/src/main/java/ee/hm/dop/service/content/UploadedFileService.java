...
public class UploadedFileService {
    ...
    public Response getArchivedFile(Long fileId) {
        ...
        File zipFile = FileUtils.getFile(sourcePath + ZipService.ZIP_EXTENSION);
        if (zipFile.exists()) return Response.ok(FileUtils.getFile(sourcePath + ZipService.ZIP_EXTENSION)).build();
