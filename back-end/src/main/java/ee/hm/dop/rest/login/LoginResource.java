...
public class LoginResource extends BaseResource {
    ...
    private static final String HARID_AUTHENTICATION_URL = "%s?client_id=%s&redirect_uri=%s&scope=openid+profile+email+personal_code+session_type&response_type=code";
