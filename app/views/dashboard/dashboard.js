define([
    ...
    var dashboard = function($scope, $location, $sce, $templateRequest, $compile, translationService) {
        var collection = null;
    ...
    dashboard.$inject = ['$scope', '$location', '$sce', '$templateRequest', '$compile', 'translationService'];
