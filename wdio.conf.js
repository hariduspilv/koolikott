exports.config = {
    ...
    /*
    There are 2 configuration files because multiple screen width config produces incorrect results
    There is an issue on git about the screenWidth resize here where it is fixed but is not yet implemented into the
    package: https://github.com/webdriverio/webdrivercss/issues/151
     */
    ...
    plugins: {
        webdrivercss: {
            screenshotRoot: './app/tests/screenshots/reference',
            failedComparisonsRoot: './app/tests/screenshots/fails',
