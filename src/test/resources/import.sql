...
insert into LanguageString(id, lang, textValue, material) values (3, 'rus', 'test description in russian', 1);
insert into LanguageString(id, lang, textValue, material) values (4, 'eng', 'test description in english', 3);
insert into LanguageString(id, lang, textValue, material) values (5, 'ara', 'test description in arabic', 3);
