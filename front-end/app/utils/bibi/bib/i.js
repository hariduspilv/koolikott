...
!function () {
    if (!window["bibi:pipi"]) {
        ...
        e.Path = function () {
            ...
            e.Status = "Started";
            for (var t = document.body.querySelectorAll("a[data-bibi]"), i = t.length, n = 0; i > n; n++)if (t[n].getAttribute("href") && !t[n].Bibi) {
                var o = {Index: n, Number: n + 1}, a = o.Anchor = t[n];
                / bibi-anchor /.test(" " + a.className + " ") || (a.className = "bibi-anchor" + (a.className ? " " + a.className : ""));
                var r = Href = a.getAttribute("href"), d = a.getAttribute("data-bibi-class"), s = a.getAttribute("data-bibi-id"), b = a.getAttribute("data-bibi-style"), u = a.getAttribute("data-bibi-reader-view-mode"), c = a.getAttribute("data-bibi-fix-reader-view-mode"), l = a.getAttribute("data-bibi-autostart"), m = a.getAttribute("data-bibi-start-in-new-window"), h = a.getAttribute("data-bibi-use-slider"), g = a.getAttribute("data-bibi-use-arrows"), p = a.getAttribute("data-bibi-use-keys"), f = a.getAttribute("data-bibi-use-swipe"), v = a.getAttribute("data-bibi-use-cookie"), w = a.getAttribute("data-bibi-to"), y = a.getAttribute("data-bibi-nav"), E = a.innerHTML;
                a.origin != location.origin && e.TrustworthyOrigins.push(a.origin), a.addEventListener("bibi:loaded", function (e) {
                    console.log("BiB/i: Loaded. - #" + e.detail.Number + ": " + e.detail.Anchor.href)
                }, !1), e.Anchors.push(a);
                var B = o.Holder = e.create("span", {
                    className: "bibi-holder",
                    id: "bibi-holder-" + (n + 1),
                    title: (a.innerText ? a.innerText + " " : "") + "(powered by BiB/i)"
                });
                d && (B.className += " " + d), s && (B.id = s), b && B.setAttribute("style", b), e.Holders.push(B);
                var A = new e.Fragment;
                ...
                var C = o.Frame = B.appendChild(e.create("iframe", {
                ...
                }, !1), e.Frames.push(C), e.Bibis.push(o), C.Bibi = B.Bibi = a.Bibi = o
            }
            for (var n = 0, i = e.Bibis.length; i > n; n++)if (!e.Bibis[n].Embedded) {
                var o = e.Bibis[n];
                o.move = function (e) {
            ...
            return this.Fragment = [], this.add = function (e, t) {
                this.Fragment.push([e, t].join(":"))
            }, this.make = function () {
            ...
            if (t && t.data)for (var i = 0, n = e.TrustworthyOrigins.length; n > i; i++)if (t.origin == e.TrustworthyOrigins[i]) {
                var o = t.data;
                try {
            ...
            console.log("BiB/i: Readied. - " + e.detail.Bibis.length + " Bibi(s).")
