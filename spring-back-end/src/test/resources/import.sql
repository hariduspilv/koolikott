...
insert into AuthenticatedUser(id, user_id, token, firstLogin, person, deleted, loggedOut, declined, loginFrom, loginDate, sessionTime) values (1, 1, 'token', false, null, 0, 0, 0, 'DEV', '2011-09-01 00:00:01', '2041-09-01 00:00:01');
